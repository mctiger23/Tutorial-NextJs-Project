  ...
  useEffect(()=>{
    ...
    const fetchPropertyData = async ()=>{
        try {
            ...
            // check rates for null , if null make empty string 
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor="amenity_highspeed_internet">
                High-Speed Internet
              </label>
            </div>
          </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="border rounded w-full py-2 px-3"
            placeholder="Name"
            value={fields.seller_info.name}zz
            onChange={handleChange}
          />
        </div>
        <div className="mb-4">
